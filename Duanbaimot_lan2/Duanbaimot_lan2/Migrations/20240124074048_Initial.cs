        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Classes_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentsSubjects", x => x.DepartmentSubjectID);
                    table.ForeignKey(
                        name: "FK_DepartmentsSubjects_Departments_DepartmentID",
                        column: x => x.DepartmentID,
                        principalTable: "Departments",
                        principalColumn: "DepartmentID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmentsSubjects_Subjects_SubjectID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeachingSchedules_Classes_ClassID",
                        column: x => x.ClassID,
                        principalTable: "Classes",
                        principalColumn: "ClassID");
                    table.ForeignKey(
                        name: "FK_TeachingSchedules_Instructors_InstructorID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classes_ApplicationUserId",
                table: "Classes",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentsSubjects_DepartmentID",
                table: "DepartmentsSubjects",
                column: "DepartmentID");

            migrationBuilder.CreateIndex(
                name: "IX_DepartmentsSubjects_SubjectID",
                table: "DepartmentsSubjects",
                column: "SubjectID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeachingSchedules_ClassID",
                table: "TeachingSchedules",
                column: "ClassID");

            migrationBuilder.CreateIndex(
                name: "IX_TeachingSchedules_InstructorID",
                table: "TeachingSchedules",
                column: "InstructorID");
        }
